...
impl WeChatStyleAdapter {
    pub fn new() -> Self {
        ...
        inline_styles.insert("p".to_string(), 
            "font-size: 16px; line-height: 1.8; margin: 20px 0; color: #333; text-align: justify;".to_string());
        ...
        inline_styles.insert("h3".to_string(), 
            "font-size: 18px; font-weight: bold; margin: 20px 0 10px 0; color: #34495e;".to_string());
        
        inline_styles.insert("h4".to_string(), 
        ...
        inline_styles.insert("table".to_string(), 
        ...
        Self {
            ...
            allowed_tags: vec![
                ...
                "img", "a", "section", "article", "aside", "nav",
            ],
        }
    }
        ...
        for (selector_str, style) in &self.inline_styles {
            ...
            result = tag_regex.replace_all(&result, |caps: &regex::Captures| {
                ...
                if existing_attrs.contains("style=") {
                    ...
                    style_regex.replace(existing_attrs, |style_caps: &regex::Captures| {
    ...
    fn convert_external_links(&self, html: &str) -> Result<String> {
        ...
        let result = link_regex.replace_all(html, |caps: &regex::Captures| {
            ...
            if url.starts_with("http") {
                ...
                // 保留内部链接
                format!(r#"<span style="color: #3498db; text-decoration: underline;">{}</span>"#, text)
            }
        }).to_string();
